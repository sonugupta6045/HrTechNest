...
export default function AdminGuidelinesPage() {
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <DashboardHeader heading="System Guidelines" text="Company policies, procedures and best practices for HR processes" />
                      ...
                      <div key={index} className="border rounded-lg">
                        ...
                        >
                          ...
                          <div className="flex items-center">
                            ...
                            <ChevronDown
                              className={`h-5 w-5 transition-transform ${openSection === (catIndex * 100 + index) ? "transform rotate-180" : ""
                                }`}
                            />
                          </div>
                        </button>
                  ...
                  <div key={index} className="border rounded-lg">
                    ...
                    >
                      ...
                      <div className="flex items-center">
                        ...
                        <ChevronDown
                          className={`h-5 w-5 transition-transform ${openSection === (100 + index) ? "transform rotate-180" : ""
                            }`}
                        />
                      </div>
                    </button>
                  ...
                  <div key={index} className="border rounded-lg">
                    ...
                    >
                      ...
                      <div className="flex items-center">
                        ...
                        <ChevronDown
                          className={`h-5 w-5 transition-transform ${openSection === (200 + index) ? "transform rotate-180" : ""
                            }`}
                        />
                      </div>
                    </button>
